# -*- coding: utf-8 -*-
"""
Created on Tue Aug 30 11:17:08 2022
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def change_looks(self):
        ...
        if -5 <= em <= 5:
            self.ui.labelShowlmg.setPixmap(QtGui.QPixmap(":/re/talk.gif"))
        elif -10 <= em <= -5:
            self.ui.labelShowlmg.setPixmap(QtGui.QPixmap(":/re/empty.gif"))
        elif -15 <= em <= 10:
            self.ui.labelShowlmg.setPixmap(QtGui.QPixmap(":/re/angry.gif"))
        elif -5 <= em <= 15:
            self.ui.labelShowlmg.setPixmap(QtGui.QPixmap(":/re/happy.gif"))
            
    def writeLog(self):
        now = 'Pityna System Dialogue Log: ' + datetime.datetime.now().strftime('%Y-%m-%d %H:%m::%S') + '\n'
